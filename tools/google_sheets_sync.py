...
CONFIG_FILE = Path(__file__).parent.parent / "google_sheet_config.json"
LOCAL_TRACKER_CSV = Path(__file__).parent.parent / "job_search_tracker.csv"
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "--set-webhook":
        ...
        print("Usage: python3 tools/google_sheets_sync.py [--set-webhook <url> | --test-row | --file <path>]")
